    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(max_length=20, null=True, blank=True)),
                ('gender',
                 models.CharField(default=b'Man', max_length=5, choices=[(b'Man', b'Man'), (b'Woman', b'Woman')])),
                ('user_type', models.CharField(default=b'Printer', max_length=7,
                                               choices=[(b'Seller', b'Seller'), (b'Printer', b'Printer')])),
                ('groups',
